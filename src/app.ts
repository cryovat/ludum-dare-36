...
interface IInterpreterOptions {
    name?: string,
    prompt?: string,
    onExit?: IInterpreterCallback,
    onStart?: IInterpreterCallback,
    keydown?: Function
}
...
interface IInterpreter {
    (command: string, term: ITerminal): void;
}

interface IInterpreterCallback {
    (term: ITerminal): void;
}
...
interface ITerminal {
    ...
    pause(): void;
    resume(): void;
    echo(value: string | Function, options?: IEchoOptions);
    error(value: string | Function);
    level(): number;
    ...
    set_interpreter(interpreter: IInterpreter);

    push(interpreter: IInterpreter, options?: IInterpreterOptions);
    pop(): void;
}

// ReSharper restore InconsistentNaming

const lsBanner = `\x1B[33mw/\x1B[30;41m\u25CF\x1B[33;40mS Mainfr\x1B[30;41m\u25CF\x1B[33;40mme System 36.0.2a
Cop\x1B[30;41m\u25CF\u25CF\x1B[33;40mright (C) 1986 Winter\x1B[30;41m\u25CF\x1B[33;40may Corpor\x1B[30;41m\u25CF\u25CF\u25CF\u25CF\x1B[0m

\x1B[31mCRIT 0x0\x1B[30;41m\u25CF\x1B[31;40mA7: Serial cab\x1B[30;41m\u25CF\x1B[31;40me at COM01 fau\x1B[30;41m\u25CF\x1B[31;40mty
\x1B[31mCRIT 0x00B3: D\x1B[30;41m\u25CF\x1B[31;40msk controller failu\x1B[30;41m\u25CF\x1B[31;40me
\x1B[31mC\x1B[30;41m\u25CF\x1B[33140m\x1B[30;41m\u25CF\x1B[31;40mT 0x00B6: Keyboard co\x1B[30;41m\u25CF\x1B[31;40mtroller fail\x1B[30;41m\u25CF\x1B[31;40mre

`;

const osStatus = `
\x1B[33mWARN 0x0063: Network access limited
\x1B[31mCRIT 0x00A2: File syst\x1B[30;41m\u25CF\x1B[31;40mm damage in sect\x1B[30;41m\u25CF\u25CF\u25CF\u25CF\x1B[31;40mr 0x0\x1B[30;41m\u25CF\x1B[31;40m91\x1B[30;41m\u25CF\u25CF\u25CF\u25CF\x1B[0m
\x1B[31mCRIT 0x00A7: Serial cable at COM03 faulty

`;

const osBanner = `\x1B[33mw/OS Mainframe System 36.0.2a
Copyright (C) 1986 Winterday Corporation

\x1B[0mEden Project mainframe terminal
`;
...
Have fun and play nice! \x1B[34m(Jones: your password is grail44)
        ...
        inbox: [
            {
                from: "djones",
                subject: "Password",
                text: `i seem to have misplaced my new password. can you put a hint t\x1B[30;41m\u25CF\x1B[0me usual place?`
            },
            {
                from: "ataiga",
                subject: "RE: Simulation",
                text: `djones requested a read\x1B[30;41m\u25CF\x1B[0mut on nitrogen and carbon dioxide levels in the air supply, can you run the attached report scripts on the [MAIL TRUNCATED]`
            }
        ]
    },
    {
        ...
        inbox: [
            {
                from: "ataiga",
                subject: "RE: Simulation",
                text: ` hmm, looks like you don't have enough pr\x1B[30;41m\u25CF\x1B[0mvileges on the mainframe. i know a little trick that might work, but don't tell omalley about it, i'll send it to you soon.`
            }, {
                from: "omalley",
...
offset: 0x3151
rem: 45b
add:\x1B[36;43m\u25CF\u25CF\u25CF\u25CF\u25CF\u25CF\x1B[0mREAUTH\x1B[36;43m\u25CF\u25CF\u25CF\u25CF\x1B[0mATAIGA\x1B[36;43m\u25CF\x1B[0maustin99\x1B[36;43m\u25CF\u25CF\u25CF\u25CF\x1B[0m
pad: 19b
-- END BINPATCH PATCH --------`
            }
        ]
        ...
        inbox: [
            {
                from: "djones",
                subject: "Simulation",
                text: `The articifial life simulation you sho\x1B[30;41m\u25CF\x1B[0maed me in the lab the other day was wonderful! Could you send me a copy`
            },
            {
                from: "djones",
                subject: "RE: Simulation",
...
When I run it, there's a message about memory quota exceeded. Does that happen for you too?`
            ...
            },
            {
                ...
                text: `I'm going down to the maintenan\x1B[30;41m\u25CF\x1B[0me sector to reset a circuit breaker after a malfunction in one of the generators.

It shouldn't happen, but if the life support controller \x1B[30;41m\u25CF\x1B[0mcts up due to the power fluctuations, please log into my account using the password nightfe\x1B[30;41m\u25CF\x1B[0mer77 and
run lsdiag.com.`
            }
        ]
    }
...
class Executable {
    name: string;
    exec: IInterpreter;
    opts: IInterpreterOptions;
    corrupt: boolean;

    constructor(name: string, exec?: IInterpreter, opts?: IInterpreterOptions) {
        this.name = name;
        this.exec = exec;
        this.opts = opts;
...
class Folder {
    ...
    addChild(name: string, owner?: string): Folder {
...
{
    onStart: t => {
        t.echo(`\x1B[33mWARN 0x00E4: Severe degradation of life support system detected.\x1B[0m

\x1B[36mConnection to life support controller detected on COM3.
...
danger.addExecutable("emergency.com", victory,
    {
        onStart: t => {
            t.echo(`\x1B[31mWARNING: This program will trigger emergency explosives on the seals of the vault gate.
...
userDJones.addTextFile("notes2.txt", `Taiga showed me a delightful simulation program she devised the other da\x1B[30;41m\u25CF\x1B[0m.

I got a copy, but have had little l\x1B[30;41m\u25CF\x1B[0mck running it. Shot off a message to her asking for help.

It g\x1B[30;41m\u25CF\x1B[0mves a strange error about access control. Seems to run fine on he\x1B[30;41m\u25CF\x1B[0m user and O'Malley's.
`);
...
userATaiga.addTextFile("notes.txt", `simulation appears to work great, but should try tweaki\x1B[30;41m\u25CF\x1B[0mg the parameter to exaggerate emergent beh\x1B[30;41m\u25CF\x1B[0mi

\x1B[30;41m[TRUNCATED]`);
...
function printIoError(term: ITerminal) {
    if (loggedInAs !== null) {
...
function loginTerm(user: IUser): IInterpreter {

    return (command: string, term: ITerminal) => {
        ...
        if (normalized.length === 0) {
            ...
            if (setFolder(`/user/${user.name}`)) {
                term.echo(`\x1B[36mChanged to ${currentPath}\n\n`);
            }
...
function getFolderRec(index: number, path: string[], current: Folder): Folder {
...
function setFolder(relativePath: string): boolean {
    ...
    const folder = getFolderRec(1, parts, root);
    if (folder !== null) {
...
function fakeout(command: string, term: ITerminal) {
...
function victory(command: string, term: ITerminal) {
    window.location.href = "victory.html";
}

function mailReader(command: string, term: ITerminal) {

    var parsed: ICommand = jQuery.terminal.parse_command(command), fileName: string;
    ...
    switch (parsed.name.toLowerCase()) {
        ...
        case 'list':
            ...
            for (let i = 0; i < loggedInAs.inbox.length; i++) {
...
function wterm(command: string, term: ITerminal) {

    var parsed: ICommand = jQuery.terminal.parse_command(command), i: number, fileName: string;
    ...
    switch (parsed.name.toLowerCase()) {
        ...
        case 'login':
            if (parsed.args.length !== 1) {
                ...
                var user: IUser = null, name = parsed.args[0].trim().toUpperCase();
                ...
                if (user === null) {
                    ...
                    term.push(loginTerm(user),
                        {
                            prompt: 'password: ',
                            onStart: t => t.set_mask(true),
                            onExit: t => t.set_mask(false),
        ...
        case 'mail':
            if (loggedInAs === null) {
                ...
                term.echo(`\x1B[36mYou have 0 unr\x1B[30;41m\u25CF\x1B[0mad mail of ${loggedInAs.inbox.length} total.\n`);
            }

            break;

        case 'pwd':
            term.echo(`\x1B[36m${currentPath}\n\n`);
            break;
        ...
        case 'ls':
            ...
            for (i = 0; i < currentFolder.executables.length; i++) {
                term.echo(`\x1B[36m${currentFolder.executables[i].name}`);
            }
...
jQuery(($, undefined) => {
    ...
    var left = $("#term_timeleft").terminal((_, __) => { },
        {
            greetings: lsBanner,
            width: '30rem',
            height: '20rem',
    ...
    function processDeadline() {
        ...
        if (remain <= 1) {
            ...
            left.echo(`\x1B[33mWARN 0x0\x1B[30;41m\u25CF\x1B[33;40m63: Remaining air supply: ${Math.floor(remain / 60000)} minutes, ${Math.floor((remain % 60000) / 1000)} secon\x1B[30;41m\u25CF\x1B[33;40ms.\n\n`);
